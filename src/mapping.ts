...
import { _Approval, _OperatorTransferred,
  _OwnershipTransferred, _Transfer } from "../generated/schema"
...
export function handleOperatorTransferred(event: OperatorTransferred): void {
  let entity = _OperatorTransferred.load(event.params.newOperator.toHex())

  if (entity == null) {
    entity = new _OperatorTransferred(event.params.newOperator.toHex())
    entity.count = BigInt.fromI32(0)
  }
